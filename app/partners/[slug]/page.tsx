        ...
        <div className="mx-auto max-w-5xl">
          <div className="rounded-2xl bg-white p-6 shadow-[0_10px_40px_rgba(2,6,23,0.06)] ring-1 ring-slate-200">
            <div className="mb-4 flex items-center gap-3">
              <span className="inline-grid h-10 w-10 place-items-center rounded-full bg-pink-600 text-white"><Network className="h-5 w-5" /></span>
              <h2 className="text-xl font-extrabold text-blue-900">About {title}</h2>
            </div>
            <p className="text-sm leading-7 text-slate-700">
              This is a placeholder detail page. Provide official description, partnership scope, key initiatives,
              and impact metrics here. You can also include logo, website link, contact, and media assets.
            </p>
          </div>
        </div>
      </section>
